...
const tuesday = (time) => 
{
    let tuesdayArr = ['1', '12', '72', '14', '62', '54',' 2', '53',' 6', '55', '19', '13', '56', '28',' 2', '15',' 1', '53', '14', '56', '43', '60', '13', '61', '35', '42', '54', '11', '0', '51', '66',' 1', '32', '58', '65', '19',' 2', '64', '58',' 6', '14', '54', '58', '27', '56', '40', '67', '53', '1', '37', '61', '31', '35', '13', '26', '14', '65', '19', '56', '11', '51', '53', '24',]
    let currShow;
    ...
    let nextObj1=dataPrograms.find(x => x.id == tuesdayArr[currShow])
    let nextObj2=dataPrograms.find(x => x.id == tuesdayArr[currShow+1])
    let nextObj3=dataPrograms.find(x => x.id == tuesdayArr[currShow+2])
    let nextObj4=dataPrograms.find(x => x.id == tuesdayArr[currShow+3])
    let nextObj5=dataPrograms.find(x => x.id == tuesdayArr[currShow+4])
