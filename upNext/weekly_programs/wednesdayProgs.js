...
{
     let wednesdayArr =['1','32','40','63','51','67','53','6','54','19','13','56','65','2','15','1','53','14','56','43','60','13','61','35','69','54','0','18','1','37','56','42','19','30','58','6','14','54','64','66','56','69','70','53','1','12','2','27','35','13','26','14','56','30','19','72','28','61','53','24']
     let currShow;
    ...
    let nextObj1=dataPrograms.find(x => x.id == wednesdayArr[currShow])
    let nextObj2=dataPrograms.find(x => x.id == wednesdayArr[currShow+1])
    let nextObj3=dataPrograms.find(x => x.id == wednesdayArr[currShow+2])
    let nextObj4=dataPrograms.find(x => x.id == wednesdayArr[currShow+3])
    let nextObj5=dataPrograms.find(x => x.id == wednesdayArr[currShow+4])
