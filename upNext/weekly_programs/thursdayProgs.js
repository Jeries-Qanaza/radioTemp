...
const thursday = (time) => 
{
        let thursdayArr = ['1','32','72','14','69','54','70','53','6','42','19','13','27','58','2','15','1','53','14','56','12','60','13','61','35','58','54','30','56','51','58','1','43','58','28','19','2','64','58','6','14','54','58','31','0','73','53','1','37','61','62','35','13','26','14','58','63','19','56','69','51','53','24']
        let currShow;
    ...
    let nextObj1=dataPrograms.find(x => x.id == thursdayArr[currShow])
    let nextObj2=dataPrograms.find(x => x.id == thursdayArr[currShow+1])
    let nextObj3=dataPrograms.find(x => x.id == thursdayArr[currShow+2])
    let nextObj4=dataPrograms.find(x => x.id == thursdayArr[currShow+3])
    let nextObj5=dataPrograms.find(x => x.id == thursdayArr[currShow+4])
